...
const addingNumbersAnonymousFunction = function(number1, number2){
    return number1 + number2;
}//this returns the actual function to the const 'addingNumbers'
//Invoke the function by referencing the variable containing the function
console.log("calling the function stored in addingNumbersAnonymousFunction  (anonymous function): "+addingNumbers(1,2));
...
//Invoke the function by referencing the variable containing the function
console.log("calling the function stored in addingNumbersArrowFunction(arrow function): "+addingNumbers(1,2));
